...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (org-agenda-property shakespeare-mode helm-ag sane-term helm-projectile base16-theme yaml-mode projectile org-bullets helm-descbinds helm-flycheck org-journal flycheck-haskell magit pg helm intero dashboard))))
(custom-set-faces
