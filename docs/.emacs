...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (sane-term helm-projectile base16-theme color-theme-sanityinc-tomorrow yaml-mode projectile org-bullets helm-descbinds helm-flycheck org-journal flycheck-haskell magit pg helm intero dashboard))))
(custom-set-faces
